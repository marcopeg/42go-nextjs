...
updatedAt: 2026-05-01T15:26:12+00:00
---
...
Books with status "reading" render a clear overlay band on top of the cover in the books list UI. Clicking those books opens the reader view directly and restores the user to the correct reading position (scroll/progress anchor).
...
- The reader opens at the correct saved reading position for that user/book.
- Non-reading books keep expected click behavior unless explicitly changed in implementation planning.
...
- What exact visual treatment should the "reading" band use (placement, color, text style)?
- Should non-reading books continue opening the info/details page or also open reader?
- What is the fallback behavior if a reading book has missing or invalid saved progress?
