...
---
# quicklist - support edit task title in task list UI

## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Add support for editing a task's title directly in the quicklist task list UI.

## Retrieval Anchors
- `ACU`
- `docs/backlog/tasks/ACU-quicklist-support-edit-task-title-in-task-list-ui-acu`
- `ACU.task.md`

## Durable Outcome and Decisions
- The source preserves the task’s scope through these sections: Goals; Acceptance Criteria.
...
- Consolidated artifacts: `ACU.history.archived.acu-task.md`, `ACU.task.md`.
