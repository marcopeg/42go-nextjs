...
## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Simplify the root layout by moving Nav and other UI responsibilities into a dedicated component that might be used as Page's wrapper instead.

## Retrieval Anchors
- `AAU`
- `docs/backlog/tasks/AAU-implement-public-layout-aau`
- `AAU.task.md`
...
- The source preserves the task’s scope through these sections: Development Plan - Route Group Approach; Implementation Results.
...
- Consolidated artifacts: `AAU.task.md`.
