...
---
# Create Calendar App Config

## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Create new config for the calendar app that answers to calendar.localhost:3000

## Retrieval Anchors
- `ACN`
- `docs/backlog/tasks/ACN-create-calendar-app-config-acn`
- `ACN.task.md`
- `calendar`
- `src/AppConfig.ts`
...
- The source preserves the task’s scope through these sections: Goals; Acceptance Criteria; Progress; Issues Encountered; Libraries Used; Next Steps; Goals; Acceptance Criteria.
...
- Consolidated artifacts: `ACN.task.md`.
