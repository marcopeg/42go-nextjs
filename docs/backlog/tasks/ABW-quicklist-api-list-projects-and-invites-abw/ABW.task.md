...
---
# quicklist - API: list projects and invites

## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Implement GET /api/quicklists to return projects for the current user and pending invites, secured by unified policy guard.

## Retrieval Anchors
- `ABW`
- `docs/backlog/tasks/ABW-quicklist-api-list-projects-and-invites-abw`
- `ABW.task.md`
- `src/app/api/quicklists/route.ts`
- `protectRoute`
- `require: { feature: "api:quicklists", session: true, role: "user" }`
- `limit`
- `cursor`
- `{ updatedAt: Date, id: uuid }`

## Durable Outcome and Decisions
- The source preserves the task’s scope through these sections: Context; Goals; Acceptance Criteria; API Contract; Implementation Notes; Next Steps; Development Plan.
...
- Consolidated artifacts: `ABW.task.md`.
