...
---
# Support different public layout based on App-config

## Historical Summary
This archived record consolidates the task’s retained intent and decisions. The idea is to allow the AppConfig to define a 'theme.PublicLayout' that references an imported layout component and defaults to the 'components/PublicLayout'.

## Retrieval Anchors
- `AAC`
- `docs/backlog/tasks/AAC-support-different-public-layout-based-on-app-config-aac`
- `AAC.task.md`
- `theme.PublicLayout`
- `components/PublicLayout`
- `src/app/(public)/layout.tsx`
- `src/components/{PublicLayout}`
- `src/components/{layoutName}`
- `src/AppConfig.ts`

## Durable Outcome and Decisions
- The source preserves the task’s scope through these sections: Development Plan; Completion Summary.
...
- Consolidated artifacts: `AAC.task.md`.
