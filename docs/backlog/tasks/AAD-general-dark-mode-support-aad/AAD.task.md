...
## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Support dark mode (light/dark theme) at Tailwind level.

## Retrieval Anchors
- `AAD`
- `docs/backlog/tasks/AAD-general-dark-mode-support-aad`
- `AAD.task.md`
- `tailwind.config.js`
- `darkMode: ["class"]`
- `.dark`
- `next-themes@^0.4.6`
- `src/lib/config/ThemeProvider.tsx`
- `attribute="class"`

## Durable Outcome and Decisions
- The source preserves the task’s scope through these sections: Goal; Acceptance Criteria.
...
- Consolidated artifacts: `AAD.task.md`.
