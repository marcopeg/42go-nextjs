...
---
# Make the app iPhone home-screen compatible

## Historical Summary
This archived record consolidates the task’s retained intent and decisions. Enable install to iPhone home screen (and basic PWA install elsewhere) with config-driven name and icon, integrated with our AppConfig and Next.js Metadata.

## Retrieval Anchors
- `ACZ`
- `docs/backlog/tasks/ACZ-make-the-app-iphone-home-screen-compatible-acz`
- `ACZ.task.md`
- `@/42go`
- `(public)`
- `(app)`
...
- The source preserves the task’s scope through these sections: Goals; Acceptance Criteria; Proposed Design; Implementation Notes; Next Steps; Open Questions; Validation.
...
- Consolidated artifacts: `ACZ.task.md`.
