...
- [NC71: HeroBlock: Add Alignment Option](./refined/NC71-heroblock-add-alignment-option/NC71.task.md) | [plan](./refined/NC71-heroblock-add-alignment-option/NC71.plan.md)
- [NQ76: Store Database Dumps Under .local](./refined/NQ76-store-database-dumps-under-local/NQ76.task.md) | [plan](./refined/NQ76-store-database-dumps-under-local/NQ76.plan.md)
- [ER70: Store Event Exports in Monthly CSV and Parquet Files](./refined/ER70-store-event-exports-in-monthly-csv-and-parquet-files/ER70.task.md)
...
- [FN30: Remove Google Fonts Build Network Dependency](./wip/FN30-remove-google-fonts-build-network-dependency/FN30.task.md) | [plan](./wip/FN30-remove-google-fonts-build-network-dependency/FN30.plan.md) | [notes](./wip/FN30-remove-google-fonts-build-network-dependency/FN30.notes.md)
