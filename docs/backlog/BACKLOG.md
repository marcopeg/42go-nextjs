...
- [VT44: Reduce Reader Page Transition Flicker With Delayed Loading State](./drafts/VT44-reduce-reader-page-transition-flicker-with-delayed-loading-state/VT44.task.md)
- [BL01: Books Top-Bar Language and Level Switcher via GM77 Panel](./drafts/BL01-books-top-bar-language-level-switcher-via-gm77-panel/BL01.task.md)
- [ZJ19: After GM77, Add Mobile Reader Table of Contents Popup](./drafts/ZJ19-after-gm77-add-mobile-reader-table-of-contents-popup/ZJ19.task.md)
- [TF15: Move Reader Customization to Core Overlay Surface](./drafts/TF15-move-reader-customization-to-core-overlay-surface/TF15.task.md)
- [GM77: Design Reusable Overlay Surface Component and Agent Skill](./drafts/GM77-design-reusable-overlay-surface-component-and-agent-skill/GM77.task.md)
...
- [ADD: Implement CLI Scripts](./drafts/ADD-implement-cli-scripts/ADD.task.md)
...
- [AAN: App-Specific Session Configuration [aan]](./drafts/AAN-app-specific-session-configuration-aan/AAN.task.md)
- [ABD: Optimize Database Documentation [abd]](./drafts/ABD-optimize-database-documentation-abd/ABD.task.md)
- [ABE: Optimize Theming Documentation [abe]](./drafts/ABE-optimize-theming-documentation-abe/ABE.task.md)
- [ABF: Optimize Route Groups Documentation [abf]](./drafts/ABF-optimize-route-groups-documentation-abf/ABF.task.md)
- [ABG: Optimize Feature Flags Documentation [abg]](./drafts/ABG-optimize-feature-flags-documentation-abg/ABG.task.md)
- [ABH: Optimize App Config Documentation [abh]](./drafts/ABH-optimize-app-config-documentation-abh/ABH.task.md)
- [ABK: Add Social Login: X [abk]](./drafts/ABK-add-social-login-x-abk/ABK.task.md)
- [ABL: Add Social Login: LinkedIn [abl]](./drafts/ABL-add-social-login-linkedin-abl/ABL.task.md)
- [ABX: Improve User Menu [abx]](./drafts/ABX-improve-user-menu-abx/ABX.task.md)
- [ACM: Parse Relative Urls [acm]](./drafts/ACM-parse-relative-urls-acm/ACM.task.md)
- [ADN: Add config.match.fn [adn]](./drafts/ADN-add-config-match-fn-adn/ADN.task.md)
- [ADR: RBAC Refactor Policies [adr]](./drafts/ADR-rbac-refactor-policies-adr/ADR.task.md)
- [ADW: Client Policy Hook and Component [adw]](./drafts/ADW-client-policy-hook-and-component-adw/ADW.task.md)
- [AEA: Policy & RBAC Testing Strategy [aea]](./drafts/AEA-policy-rbac-testing-strategy-aea/AEA.task.md)
- [AEF: Design anyPolicy OR Helper [aef]](./drafts/AEF-design-anypolicy-or-helper-aef/AEF.task.md)
- [AEG: Unified Policy Engine Tests Implementation [aeg]](./drafts/AEG-unified-policy-engine-tests-implementation-aeg/AEG.task.md)
- [AEI: Extract Policy Utilities & Refactor Imports [aei]](./drafts/AEI-extract-policy-utilities-refactor-imports-aei/AEI.task.md)
