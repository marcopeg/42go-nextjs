...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Main Content */}
      <main
        className={`flex-1 transition-all duration-300 ease-in-out min-h-screen overflow-visible max-w-full px-6
      ...
      >
        ...
        {/* Page Content */}
        <div className="container mx-auto px-0 h-full flex flex-col max-w-full">{children}</div>
      </main>
    </div>
  );
}
