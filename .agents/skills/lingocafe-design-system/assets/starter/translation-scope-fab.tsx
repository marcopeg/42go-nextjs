...
export type TranslationScope = "sentence" | "word";
...
const getNextScope = (scope: TranslationScope): TranslationScope =>
    ...
    <div className="group relative inline-flex" style={style}>
      ...
      >
        ...
        >
          <span
            key={scope}
            className="absolute inset-0 flex items-center justify-center animate-[translation-scope-badge-roll-up_180ms_ease-out] motion-reduce:animate-none"
          >
            {scopeBadge}
          </span>
        </span>
