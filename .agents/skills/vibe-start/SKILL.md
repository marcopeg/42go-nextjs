---
name: vibe-start
description: Starts or resumes a documented vibe coding session. Use when a new vibe session is requested or when exploratory work should begin with a structured session workspace and paired long-term memory document.
---
...
Do this before deeper repo exploration.
...
Build a focused structural overview:
...
- the first concrete question, risk, or next action
