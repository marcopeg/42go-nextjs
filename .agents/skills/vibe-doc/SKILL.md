---
name: vibe-doc
description: Maintains documentation for an open vibe coding session. Use during a session to append factual notes and to promote stable findings from the live session into the paired long-term memory document and other permanent docs.
---
