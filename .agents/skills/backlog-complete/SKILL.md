...
description: Marks one or more wip tasks in docs/backlog as completed, moves their files to completed storage, and appends them to the dedicated completed history log.
---
